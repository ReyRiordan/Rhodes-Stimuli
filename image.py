...
def generate_SD3(word: str) -> list[BytesIO]:
    api_key = os.getenv("STABILITY_API_KEY")
    prompt = f"A single new species of animal called a {word} in cartoon pokemon art style, 2-dimensional, sulfur grey pale green sepia red lilac, isolated on pure white background."
