...
def generate_SD3(word: str) -> list[BytesIO]:
    api_key = os.getenv("STABILITY_API_KEY")
    prompt = f"A single new LIMBLESS (NO ARMS, NO LEGS) creature called a {word} in cartoon pokemon art style, 2-dimensional, isolated on pure white background. Inspired by snakes"
